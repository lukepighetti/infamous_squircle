...
class SquircleRectangleBorder extends OutlinedBorder {
  ...
  Path _getPath(RRect rrect) {
    ...
    limitedRadius = math.min(
      largestRadius,
      minSideLength / 2 * maxStadiumRatio,
    );
